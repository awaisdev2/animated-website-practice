  ...
  return (
    ...
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl text-white font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">I'm a Frontend Developer</h1>
            <p className="max-w-2xl font-light text-gray-200 md:text-lg lg:text-xl">With two years of experience in creating modern, animated and responsive web pages I'm an expert in HTML, CSS, JS/TS, Bootstrap, Tailwind CSS, Semantic UI and React.</p>
            <div className="flex mt-6">
              <a href="https://instagram.com/awais_dev" target='_blank' rel="noreferrer">
                <motion.div
                ...
                >
                  {isHoverChat ? (
                    <img className='h-9' style={{ mixBlendMode: 'multiply' }} src={chatImgGif} alt="img" />
                  ) : (
                    <img className='h-8' src={chatImg} alt="img" />
                  )}
                  </motion.div>
                </a>
                <a href="https://www.facebook.com/profile.php?id=100084660172027" target='_blank' rel="noreferrer">
                <motion.div
                  whileHover={{ scale: 1.2 }}
                  whileTap={{ scale: 0.9 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                ...
                >
                    {isHoverFb ? (
                    <img className='h-9' style={{ mixBlendMode: 'multiply' }} src={FbImgGif} alt="img" />
                  ) : (
                    <img className='h-8' src={FbImg} alt="img" />
                  )}
                </motion.div>
              </a>
                <a href="https://github.com/awaisdev2" target='_blank' rel="noreferrer">
                <motion.div
                  whileHover={{ scale: 1.2 }}
                  whileTap={{ scale: 0.9 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                ...
                >
                    {isHoverCat ? (
                    <img className='h-9' style={{ mixBlendMode: 'multiply' }} src={catImgGif} alt="img" />
                  ) : (
